...
return [
  ...
  'Case' => [
    'attributes' => [
      ...
      'cProductRequestedName' => [
        'type' => 'foreign',
        'notStorable' => true,
        'attributeRole' => 'name',
        'fieldType' => 'link',
        'relation' => 'cProductRequested',
        'foreign' => 'name',
        'foreignType' => 'varchar'
      ],
      'isFollowed' => [
    ...
    'indexes' => [
      ...
      'cProductRequestedId' => [
        'type' => 'index',
        'columns' => [
          0 => 'cProductRequestedId'
        ],
        'key' => 'IDX_C_PRODUCT_REQUESTED_ID'
      ]
    ],
    'fullTextSearchColumnList' => [
      0 => 'name',
  ...
  'CProduct' => [
    ...
    'relations' => [
      ...
      'cases' => [
        'type' => 'hasMany',
        'entity' => 'Case',
        'foreignKey' => 'cProductRequestedId',
        'foreign' => 'cProductRequested'
      ],
      'teams' => [
        'type' => 'manyMany',
        'entity' => 'Team',
    ...
    'attributes' => [
      ...
      'purchasePrice' => [
        ...
        'order' => [
          'order' => [
            0 => [
              0 => 'MUL:(purchasePrice, purchasePriceCurrencyRate.rate)',
              1 => '{direction}'
            ]
          ],
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'purchasePriceCurrencyRate',
              2 => [
                'purchasePriceCurrencyRate.id:' => 'purchasePriceCurrency'
              ]
            ]
          ],
          'additionalSelect' => [
            0 => 'purchasePriceCurrencyRate.rate'
          ]
        ]
      ],
      'quantity' => [
      ...
      'totalValue' => [
        ...
        'order' => [
          'order' => [
            0 => [
              0 => 'MUL:(totalValue, totalValueCurrencyRate.rate)',
              1 => '{direction}'
            ]
          ],
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'totalValueCurrencyRate',
              2 => [
                'totalValueCurrencyRate.id:' => 'totalValueCurrency'
              ]
            ]
          ],
          'additionalSelect' => [
            0 => 'totalValueCurrencyRate.rate'
          ]
        ]
      ],
      'licenseExpiry' => [
      ...
      'purchasePriceConverted' => [
        'type' => 'float',
        'select' => [
          'select' => 'MUL:(purchasePrice, purchasePriceCurrencyRate.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'purchasePriceCurrencyRate',
        ...
        'selectForeign' => [
          'select' => 'MUL:({alias}.purchasePrice, purchasePriceCurrencyRateCSoftware{alias}Foreign.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'purchasePriceCurrencyRateCSoftware{alias}Foreign',
              2 => [
                'purchasePriceCurrencyRateCSoftware{alias}Foreign.id:' => '{alias}.purchasePriceCurrency'
              ]
            ]
          ]
        ],
        'where' => [
          '=' => [
            'whereClause' => [
              'MUL:(purchasePrice, purchasePriceCurrencyRate.rate)=' => '{value}'
            ],
            'leftJoins' => [
              0 => [
                0 => 'Currency',
      ...
      'totalValueConverted' => [
        'type' => 'float',
        'select' => [
          'select' => 'MUL:(totalValue, totalValueCurrencyRate.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'totalValueCurrencyRate',
        ...
        'selectForeign' => [
          'select' => 'MUL:({alias}.totalValue, totalValueCurrencyRateCSoftware{alias}Foreign.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'totalValueCurrencyRateCSoftware{alias}Foreign',
              2 => [
                'totalValueCurrencyRateCSoftware{alias}Foreign.id:' => '{alias}.totalValueCurrency'
              ]
            ]
          ]
        ],
        'where' => [
          '=' => [
            'whereClause' => [
              'MUL:(totalValue, totalValueCurrencyRate.rate)=' => '{value}'
            ],
            'leftJoins' => [
              0 => [
                0 => 'Currency',
